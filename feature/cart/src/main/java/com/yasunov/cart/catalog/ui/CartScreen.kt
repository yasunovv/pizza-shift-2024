...
import com.yasunov.cart.catalog.model.PizzaItemUiState
    ...
    ShiftScaffold(
        topBar = {
            TopAppBar(
                ...
                Text("Корзина", style = Typography.h5, color = ShiftAppInternTheme.colors.titleText)
...
//            )
//
//            is PizzaItemUiState.Error -> ErrorScreen(onClickButton = { viewModel.loadCart() })
//        }
    }
